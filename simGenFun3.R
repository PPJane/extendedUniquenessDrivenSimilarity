...
# The rest of the code would be the same as in Fun1
# Distance matrix similarity calculation is added as above, therefore, the degree of freedom adds by one, t_g = 1
# # 1. Goodall's similarity -----------------------------------------------
...
Dlist_chi <- list(D_ki2_Amount, D_ki2_Rating, D_ki2_YelpTag1, D_ki2_YelpTag2, D_ki2_YelpTag3, D_ki2_Dist)