...
# The code is the same as in Fun2
# The distance matrix similarity calculation is taken out, and the degree of freedom corresponding to the distance matrix decreased by one, t_g = 0.
# # 2. Our proposed similarity --------------------------------------------
...
D_ki2_Tag <- D_Tag <- D_ki2_Amount <- D_ki2_Rating <- matrix(0, n, n)
...
Dlist_chi <- list(D_ki2_Tag, D_ki2_Amount, D_ki2_Rating)